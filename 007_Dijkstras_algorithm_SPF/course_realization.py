...
class Node:
    ...
    def __init__(self, name):
        self.name = name
        self.visited = False
        # this is the node where we came from the shortest path
        self.predecessor = None
        self.adjacency_list = []
        # this is shortest path from predecessor node
...
class DijkstraAlgorithm:
    ...
    def calculate(self, start_vertex: Node):
        ...
        while self.heap:
            ...
            # we pop the vertex with lowest min_distance paremeter
            ...
            for edge in actual_vertex.adjacency_list:
                ...
                # we have to compare the min distance
                new_distance = u.min_distance + edge.weight

                # there is the shortest path to the v vertex
                if new_distance < v.min_distance:
                    # when there is a shortest path available the we update
                    # the predecessor accordingly:
                    v.predecessor = u
                    v.min_distance = new_distance
                    # update the heap - this is the lazy implementation
                    # because it takes O(N) to find the vertex we want
                    # to update (v)
